...
<head>
    ...
    <title>Reset Password – SmartBK</title>
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="field">
                ...
                <input type="email" name="email" value="{{ old('email', $email) }}"
                       class="field__input" readonly>
            </div>

            <div class="field">
                <label class="field__label">New Password</label>
                <input type="password" name="password" required autofocus
                       class="field__input" placeholder="Masukkan password baru">
                @error('password')<p class="field__hint">{{ $message }}</p>@enderror
            </div>

            <div class="field">
                <label class="field__label">Verifikasi New Password</label>
                <input type="password" name="password_confirmation" required
                       class="field__input" placeholder="Ulangi password baru">
            </div>
