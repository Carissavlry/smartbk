...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        data-label="Data Siswa Binaan">
            ...
            <span class="nav-item__label">Siswa Binaan</span>
        </a>
        ...
        data-label="Pengajuan Konseling">
            ...
            <span class="nav-item__label">Pengajuan Masuk</span>
        </a>
        ...
        <div class="nav-section-label">Kedisiplinan & Rekam Track</div>
        ...
        data-label="Papan Pengumuman">
            ...
            <span class="nav-item__label">Pengumuman</span>
        </a>

        <!-- REKAPITULASI & PENGATURAN -->
        <div class="nav-section-label">Laporan & Akun</div>
        ...
        data-label="Laporan">
            ...
            <span class="nav-item__label">Laporan Rekap</span>
        </a>
